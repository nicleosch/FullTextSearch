...
static const struct among a_0[3] = {
    {5, s_0_0, -1, -1, 0}, {6, s_0_1, -1, -1, 0}, {5, s_0_2, -1, -1, 0}};
...
static const struct among a_1[3] = {
    {1, s_1_0, -1, 1, 0}, {3, s_1_1, 0, 1, 0}, {2, s_1_2, -1, 1, 0}};
...
static const struct among a_2[6] = {{3, s_2_0, -1, 2, 0}, {1, s_2_1, -1, 3, 0},
                                    {3, s_2_2, 1, 2, 0},  {4, s_2_3, 1, 1, 0},
                                    {2, s_2_4, 1, -1, 0}, {2, s_2_5, 1, -1, 0}};
...
static const struct among a_3[13] = {
    {0, 0, -1, 3, 0},    {2, s_3_1, 0, 2, 0}, {2, s_3_2, 0, 2, 0},  {2, s_3_3, 0, 2, 0},
    {2, s_3_4, 0, 2, 0}, {2, s_3_5, 0, 1, 0}, {2, s_3_6, 0, 2, 0},  {2, s_3_7, 0, 2, 0},
    {2, s_3_8, 0, 2, 0}, {2, s_3_9, 0, 2, 0}, {2, s_3_10, 0, 1, 0}, {2, s_3_11, 0, 2, 0},
    {2, s_3_12, 0, 1, 0}};
...
static const struct among a_4[6] = {{2, s_4_0, -1, 2, 0}, {3, s_4_1, 0, 1, 0},
                                    {3, s_4_2, -1, 2, 0}, {4, s_4_3, -1, 2, 0},
                                    {5, s_4_4, 3, 1, 0},  {5, s_4_5, -1, 2, 0}};
...
static const struct among a_5[24] = {
    {4, s_5_0, -1, 3, 0},   {4, s_5_1, -1, 2, 0},   {3, s_5_2, -1, 13, 0}, {2, s_5_3, -1, 15, 0},
    {3, s_5_4, 3, 12, 0},   {4, s_5_5, 4, 4, 0},    {4, s_5_6, 3, 8, 0},   {5, s_5_7, 3, 9, 0},
    {6, s_5_8, 3, 14, 0},   {5, s_5_9, 3, 10, 0},   {5, s_5_10, 3, 5, 0},  {5, s_5_11, -1, 8, 0},
    {6, s_5_12, -1, 12, 0}, {5, s_5_13, -1, 11, 0}, {6, s_5_14, -1, 1, 0}, {7, s_5_15, 14, 7, 0},
    {5, s_5_16, -1, 8, 0},  {5, s_5_17, -1, 7, 0},  {7, s_5_18, 17, 6, 0}, {4, s_5_19, -1, 6, 0},
    {4, s_5_20, -1, 7, 0},  {7, s_5_21, -1, 11, 0}, {7, s_5_22, -1, 9, 0}, {7, s_5_23, -1, 10, 0}};
...
static const struct among a_6[9] = {
    {5, s_6_0, -1, 4, 0}, {5, s_6_1, -1, 6, 0}, {5, s_6_2, -1, 3, 0},
    {5, s_6_3, -1, 4, 0}, {4, s_6_4, -1, 4, 0}, {6, s_6_5, -1, 1, 0},
    {7, s_6_6, 5, 2, 0},  {3, s_6_7, -1, 5, 0}, {4, s_6_8, -1, 5, 0}};
...
static const struct among a_7[18] = {
    {2, s_7_0, -1, 1, 0},  {4, s_7_1, -1, 1, 0},  {4, s_7_2, -1, 1, 0},  {4, s_7_3, -1, 1, 0},
    {4, s_7_4, -1, 1, 0},  {3, s_7_5, -1, 1, 0},  {3, s_7_6, -1, 1, 0},  {3, s_7_7, -1, 1, 0},
    {3, s_7_8, -1, 1, 0},  {2, s_7_9, -1, 1, 0},  {3, s_7_10, -1, 1, 0}, {3, s_7_11, -1, 2, 0},
    {2, s_7_12, -1, 1, 0}, {3, s_7_13, -1, 1, 0}, {3, s_7_14, -1, 1, 0}, {3, s_7_15, -1, 1, 0},
    {4, s_7_16, 15, 1, 0}, {5, s_7_17, 16, 1, 0}};

static const symbol s_8_0[1] = {'e'};
static const symbol s_8_1[1] = {'l'};

static const struct among a_8[2] = {{1, s_8_0, -1, 1, 0}, {1, s_8_1, -1, 2, 0}};
...
static const struct among a_9[8] = {
    {7, s_9_0, -1, -1, 0}, {7, s_9_1, -1, -1, 0}, {6, s_9_2, -1, -1, 0}, {7, s_9_3, -1, -1, 0},
    {6, s_9_4, -1, -1, 0}, {7, s_9_5, -1, -1, 0}, {7, s_9_6, -1, -1, 0}, {6, s_9_7, -1, -1, 0}};
...
static const struct among a_10[18] = {
    {5, s_10_0, -1, -1, 0},  {5, s_10_1, -1, -1, 0},  {4, s_10_2, -1, -1, 0},
    {6, s_10_3, -1, -1, 0},  {5, s_10_4, -1, 3, 0},   {5, s_10_5, -1, 9, 0},
    {6, s_10_6, -1, 7, 0},   {4, s_10_7, -1, -1, 0},  {4, s_10_8, -1, 6, 0},
    {5, s_10_9, -1, 4, 0},   {4, s_10_10, -1, -1, 0}, {4, s_10_11, -1, 10, 0},
    {6, s_10_12, -1, 11, 0}, {5, s_10_13, -1, 2, 0},  {4, s_10_14, -1, 1, 0},
    {3, s_10_15, -1, -1, 0}, {5, s_10_16, -1, 5, 0},  {4, s_10_17, -1, 8, 0}};
...
static int r_mark_regions(struct SN_env* z) {
  ...
  z->I[0] = z->l;
  {
    ...
    {
      int c2 = z->c;
      if (z->c + 4 >= z->l || z->p[z->c + 4] >> 5 != 3 ||
          !((2375680 >> (z->p[z->c + 4] & 0x1f)) & 1))
        goto lab2;
...
static int r_R1(struct SN_env* z) { return z->I[1] <= z->c; }

static int r_R2(struct SN_env* z) { return z->I[0] <= z->c; }
